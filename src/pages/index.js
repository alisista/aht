  ...
  render() {
    ...
    let visions = [
      ...
      },
      {
        title: '学習しながら報酬を得る',
        description:
          'プログラミング習得の一番の近道は実際に動くものを作ってみることです。ハッカートークンで仕事を受注し、初学者が実案件プロジェクトで報酬を得ながら学習できる仕組みを創ります。学習中の開発者にミッションや仕事を発注したり、今まで値段が付かなかった素人レベルの作品など、あらゆるレベルの学習・創造活動に価値を付けるトークンです。',
        icon: 'graduation-cap',
      },
      {
        title: '完全独自経済圏の構築',
        description:
          'スキルのオンラインマーケットプレイス開発や、ハッカートークンを介して物々交換プラットフォーム開発、自動報酬システムによる非中央集権DAOの構築により、ハッカートークンだけで生きていける完全独自経済圏を創り出します。また、可視化した信頼と細分化されたトークンエコノミーのネットワークを組み合わせた画期的な経済システムの構築を目指します。',
        icon: 'globe-americas',
      },
    ]
    let problems = [
      ...
      },
      {
        ...
        description:
          'もう一つ無から価値を創りだせる活動、それは学習。学習によって得た知識やスキルを使って創造活動をすることで経済圏全体の価値向上に還元できる。ハッカートークンは初学者が学習をしながらマイニングできる仕組みを創り出す。具体的には、学習ミッションを達成して報酬を受け取ったり、外部から学習プロジェクトを受注、逆にハッカー部から外部の学習者に積極的に仕事を発注も行い、本来法定通貨によって価値の付かない学習や仕事にも価値を付ける。',
    ...
    let roadmap_items = [
      ...
      },
      {
        ...
        title: '物々交換プラットフォーム',
        description:
          'スキル交換プラットフォームをさらに拡張し、ebayのように個人がハッカートークンを介してあらゆるものを交換できるプラットフォームを開発。これによって自分のスキルを活かした仕事でハッカートークンを獲得し、それとものを交換できるようになる。ハッカートークンのみで生活していける完全独自経済圏が完成する。',
    ...
    let members = [
      ...
      },
      {
        ...
        icon:
          'https://yabaiwebyasan.com/wp-content/uploads/2018/06/やばさん.png',
